    ...
    internal class Program
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (!Human())
            {
                ...
                if (realcdQ == 0)
                    ...
                    Drawing.DrawText(wts[0] - 120, wts[1] - 30, Color.Red, "Q " + realcdQ.ToString("0.0"));
                if (realcdW == 0)
                    Drawing.DrawText(wts[0] - 40, wts[1] - 30, Color.White, "W Ready");
                else
                    Drawing.DrawText(wts[0] - 40, wts[1] - 30, Color.Red, "W " + realcdW.ToString("0.0"));

                if (realcdE == 0)
                    Drawing.DrawText(wts[0] + 40, wts[1] - 30, Color.White, "E Ready");
                else
                    Drawing.DrawText(wts[0] + 40, wts[1] - 30, Color.Red, "E " + realcdE.ToString("0.0"));
            }
            else
            {
                ...
                if (realcdSQ == 0)
                    ...
                    Drawing.DrawText(wts[0] - 120, wts[1] - 30, Color.Red, "Q " + realcdSQ.ToString("0.0"));
                if (realcdSW == 0)
                    Drawing.DrawText(wts[0] - 40, wts[1] - 30, Color.White, "W Ready");
                else
                    Drawing.DrawText(wts[0] - 40, wts[1] - 30, Color.Red, "W " + realcdSW.ToString("0.0"));

                if (realcdSE == 0)
                    Drawing.DrawText(wts[0] + 40, wts[1] - 30, Color.White, "E Ready");
                else
                    Drawing.DrawText(wts[0] + 40, wts[1] - 30, Color.Red, "E " + realcdSE.ToString("0.0"));
            }
        }
        ...
        private static void InitMenu()
        {
            ...
            var comboMenu = new Menu("Combo", "Combo settings");
            {
                ...
                comboMenu.AddItem(new MenuItem("eMin", "E Min. range").SetValue(new Slider(400, 0, 750)));
                comboMenu.AddItem(new MenuItem("rCombo", "Use Switch Forms").SetValue(true));
            ...
            var harassMenu = new Menu("Harass", "Harass settings");
            {
                ...
                harassMenu.AddItem(new MenuItem("eMinHarass", "E Min. Range").SetValue(new Slider(400, 0, 750)));
                harassMenu.AddItem(new MenuItem("rComboHarass", "Use Switch Forms").SetValue(true));
            ...
            var jungleClearMenu = new Menu("JungleClear", "JungleClear settings");
            {
                ...
                jungleClearMenu.AddItem(new MenuItem("jungleclear.r", "Use Switch Forms").SetValue(true));
            ...
            var miscMenu = new Menu("More", "More Options");
            {
                miscMenu.AddItem(new MenuItem("bAuto", "Cancel Auto Attack").SetValue(false));
                miscMenu.AddItem(
                    new MenuItem("rappel", "Instant rappel").SetValue(new KeyBind("Z".ToCharArray()[0],
                        KeyBindType.Press)));
                miscMenu.AddItem(new MenuItem("hGC", "Auto Switch to Human Form").SetValue(true));
                miscMenu.AddItem(new MenuItem("fGC", "Auto Switch to Spider Form").SetValue(true));
                ...
                miscMenu.AddItem(new MenuItem("misc.stunundertower", "Stun Enemy with Tower Range").SetValue(true));
            ...
            var activatorMenu = new Menu("Activator", "Activator Settings");
            {
                activatorMenu.AddItem(new MenuItem("autoSmite", "Auto Smite").SetValue(true));
                activatorMenu.AddItem(new MenuItem("smiteEpic", "Smite Epics").SetValue(true));
                activatorMenu.AddItem(new MenuItem("smiteBig", "Smite Big Camps").SetValue(true));
                activatorMenu.AddItem(new MenuItem("smiteSmall", "Smite Small Camps").SetValue(false));
                activatorMenu.AddItem(new MenuItem("autoRanduin", "Auto Randuin").SetValue(true));
                activatorMenu.AddItem(new MenuItem("randuinEnemies", "Min Enemies: ").SetValue(new Slider(3,1,5)));
